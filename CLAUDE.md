...
**Core Value:** QR-based event operations (entry + food) must be accurate at scale — no false positives, no false negatives, no race conditions, even with 10K concurrent scans. Data integrity is non-negotiable.
