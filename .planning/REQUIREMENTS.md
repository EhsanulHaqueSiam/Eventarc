...
- [x] **OFFL-02**: On reconnection, queued scans are re-validated against current DB state — not blindly accepted
- [x] **OFFL-03**: If a queued scan would have been invalid (guest hit limit while device was offline), it's flagged as rejected retroactively and vendor device is notified
...
| OFFL-02 | Phase 7 | Complete |
| OFFL-03 | Phase 7 | Complete |
